...
(function (factory) {
    ...
    var range = (function () {
        ...
        var WrappedRange = function (sc, so, ec, eo) {
            ...
            this.insertNode = function (node) {
                ...
                /*
                var html = info.container.innerHTML;
		        var pos = html.lastIndexOf("<p><br></p><p><br></p>");
                ...
                */
                ...
                //info.container.innerHTML=html;
                return node;
            };
            this.d = function (node) {
                /* 插入元素多出2个p的 bug */
                var rng = this.wrapBodyInlineWithPara().deleteContents();
        ...
        lang: {
            'en-US': {
                ...
                link: {
                    ...
                    textToDisplay: '链接文字',
                    url: '链接地址',
                    outLinkType:'http://www.baidu.com',
    ...
    var Popover = function () {
        ...
        this.update = function ($popover, styleInfo, isAirMode) {
            ...
            if (styleInfo.image) {
                //console.dir($imagePopover.context);
                //console.dir(styleInfo.image);
                //styleInfo.image.focus();
                select_img=styleInfo.image;
                select_img.id="9908"
                $selectimage = $(styleInfo.image);
                console.dir(styleInfo.range.eo);
                document.querySelector('textarea').setSelectionRange(styleInfo.range.eo);
    ...
    var LinkDialog = function (handler) {
        ...
        this.showLinkDialog = function ($editable, $dialog, linkInfo) {
            ...
            //console.dir(select_element.innerHTML);
            //console.dir(linkInfo.range.ec.innerHTML)
        ...
        this.show = function (layoutInfo) {
            ...
            //var select_element = linkInfo.range.ec;
            //var select_element = linkInfo.range.ec.parentElement;
            console.dir(linkInfo);
            console.dir(linkInfo.range.ec.innerHTML);
            if(linkInfo.range.ec.innerHTML===undefined){

            }else{

                    if(linkInfo.range.ec.innerHTML.indexOf("<img")!=-1){
                        //has img
                        this.canShow=false;
                        console.log(" has img ");
                        canShow=false;
                ...
                /*
                if(linkInfo.range.ec.innerHTML==="<br>"){
                    if(linkInfo.range.ec.parentElement.innerHTML.indexOf("<img")!=-1){
                        //has img
                        this.canShow=false;
                        console.log(" has img ");
                        canShow=false;
        ...
        var tplDialogInfo = {
            ...
            link: function (lang, options) {
                var body = '<div class="form-group row-fluid">' +
                    ...
                    '</div>' +
                        '<div><p></p></div>'+
                    '<div><p>外链地址格式：'+lang.link.outLinkType+'</p></div>'
                        /*
